...
export const useRoomStore = defineStore("roomStore", {
    state: () => ({
        ...
        // subContracts:[],
        currentContractId: -1,
        currentContractStagesId: -1,
        currentCounterpartiesId: -1,
        currentSubContractsId: -1,
    }),
    getters: {
    ...
    actions: {
        ...
        //     try {
        //         const response = await axios.get(`${API_BASE_URL}/my-contracts`);
        //         this.contracts = response.data;
        //     } catch (error) {
        //         console.error('Ошибка при загрузке my-contracts:', error);
        //         throw error;
        //     }
        // },
        //
        // // Функция для получения данных по sub-contracts
        // async fetchSubContracts() {
        //     try {
        //         const response = await axios.get(`${API_BASE_URL}/sub-contracts`);
        ...
        // },
        //
        // // Функция для получения данных по contract-stages
        // async fetchContractStages() {
        //     try {
        //         const response = await axios.get(`${API_BASE_URL}/contract-stages`);
        ...
        // },
        //
        // // Функция для получения данных по counterparties
        // async fetchCounterparties() {
        //     try {
        //         const response = await axios.get(`${API_BASE_URL}/counterparties`);
