<template>
  <v-card class="w-25 mt-12 flex-column" elevation="20" style="background: rgba(33,103,105,2)">
    <v-card-title class="ma-2 pa-2 d-flex flex-row justify-space-between align-center">
      ...
      <router-link to="/" style="color: navajowhite">
        <v-btn text="sign in" variant="outlined" color="navajowhite" class="ma-2 pa-2" />
      </router-link>
    </v-card-title>
    <v-card-text>
      <v-text-field
    ...
    <v-card-actions class="d-flex justify-end align-center">
      <v-btn text="log in" variant="outlined" style="color: navajowhite" class="ma-4 pa-2 mt-0" @click="registrationPost" />
    </v-card-actions>
  </v-card>
</template>
